...
- (void)awakeFromNib{
    ...
    _yiLable.textColor=[UIColor colorWithRed:[arr[0] floatValue] green:[arr[1] floatValue] blue:[arr[2] floatValue] alpha:1];
    
    _jiLable.font=[UIFont systemFontOfSize:12];
    _jiLable.textColor=[UIColor colorWithRed:[arr[0] floatValue] green:[arr[1] floatValue] blue:[arr[2] floatValue] alpha:1];
